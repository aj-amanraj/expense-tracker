      ...
      <div className='w-full flex items-center justify-center px-6'>
        <div className='w-[400px] flex flex-col gap-5'>
          ...
          <form className='flex flex-col gap-5'>
            ...
            <Button variant="contained" size='large' sx={{ textTransform: 'none' }}>Sign in</Button>
          </form>
          <p className='text-gray-500 text-sm text-center mt-6'>Don't have an account?
            <span className='text-sm text-blue-500 cursor-pointer ml-1.5 hover:underline'>Sign Up</span>
          </p>
        </div>
      </div>
